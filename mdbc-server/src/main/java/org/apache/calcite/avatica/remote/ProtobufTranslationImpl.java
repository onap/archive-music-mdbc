...
import org.apache.calcite.avatica.proto.Requests.MdbcHeartbeatRequest;
...
import org.apache.calcite.avatica.proto.Responses.MdbcHeartbeatResponse;
...
public class ProtobufTranslationImpl implements ProtobufTranslation {
  ...
  static {
    ...
    reqParsers.put(MdbcHeartbeatRequest.class.getName(),
        new RequestTranslator(MdbcHeartbeatRequest.parser(),
            new Service.MdbcHeartbeatRequest()));
    ...
    respParsers.put(MdbcHeartbeatResponse.class.getName(),
            new ResponseTranslator(MdbcHeartbeatResponse.parser(), new Service.MdbcHeartbeatResponse()));
  ...
  private static List<Class<?>> getAllMessageClasses() {
    ...
    messageClasses.add(MdbcHeartbeatRequest.class);
    ...
    messageClasses.add(MdbcHeartbeatResponse.class);
