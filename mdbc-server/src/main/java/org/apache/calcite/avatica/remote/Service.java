...
public interface Service {
  ...
  MdbcHeartbeatResponse apply(MdbcHeartbeatRequest request);
  ...
  class MdbcHeartbeatRequest extends Request {
      public final String connectionId;

      MdbcHeartbeatRequest() {
        this.connectionId = null;
      }

      @JsonCreator
      public MdbcHeartbeatRequest(@JsonProperty("connectionId") String connectionId) {
        this.connectionId = connectionId;
      }

      @Override public MdbcHeartbeatResponse accept(Service service) {
        return service.apply(this);
      }

      @Override MdbcHeartbeatRequest deserialize(Message genericMsg) {
        Requests.MdbcHeartbeatRequest msg = ProtobufService.castProtobufMessage(genericMsg,
            Requests.MdbcHeartbeatRequest.class);

        MdbcHeartbeatRequest pojo =
            new MdbcHeartbeatRequest(msg.getConnectionId());
        return pojo;
      }

      @Override Requests.MdbcHeartbeatRequest serialize() {
        Requests.MdbcHeartbeatRequest.Builder builder = Requests.MdbcHeartbeatRequest.newBuilder();
      ...
      @Override public boolean equals(Object o) {
        return this == o
            || o instanceof MdbcHeartbeatRequest
            && Objects.equals(connectionId, ((MdbcHeartbeatRequest) o).connectionId);
      }
    }
  
  class MdbcHeartbeatResponse extends Response {
      public final String connectionId;

      MdbcHeartbeatResponse() {
        connectionId = null;
      }

      @JsonCreator
      public MdbcHeartbeatResponse(@JsonProperty("connectionId") String connectionId) {
        this.connectionId = connectionId;
      }
      ...
      @Override public boolean equals(Object o) {
        return this == o
            || o instanceof MdbcHeartbeatResponse
            && Objects.equals(connectionId, ((MdbcHeartbeatResponse) o).connectionId);
      }

      @Override MdbcHeartbeatResponse deserialize(Message genericMsg) {
        Responses.MdbcHeartbeatResponse msg = ProtobufService.castProtobufMessage(genericMsg,
            Responses.MdbcHeartbeatResponse.class);
        return new MdbcHeartbeatResponse(msg.getConnectionId());
      }

      @Override Responses.MdbcHeartbeatResponse serialize() {
        Responses.MdbcHeartbeatResponse.Builder builder = Responses.MdbcHeartbeatResponse.newBuilder();
        return builder.setConnectionId(connectionId).build();
      }
    }
}
