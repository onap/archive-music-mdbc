...
public abstract class AvaticaConnection implements Connection {
  ...
  private Heartbeat mdbcHeartbeater;
  ...
  private void startHeartbeat() {
      if (this.mdbcHeartbeater == null) {
          this.mdbcHeartbeater = new Heartbeat(meta, handle);
          new Thread(mdbcHeartbeater).start();
      }
  }
  ...
  public void close() throws SQLException {
    if (!closed) {
      ...
      try {
        ...
        if (null != mdbcHeartbeater) {
            this.mdbcHeartbeater.stop();
        }
  ...
  private class Heartbeat implements Runnable {
      private Meta meta;
      private Meta.ConnectionHandle ch;
      private boolean stop;

      public Heartbeat (Meta meta, Meta.ConnectionHandle ch) {
          this.meta = meta;
          this.ch = ch;
          this.stop = false;
      }
