...
import org.apache.calcite.avatica.remote.Service.MdbcHeartbeatRequest;
import org.apache.calcite.avatica.remote.Service.MdbcHeartbeatResponse;
...
public class LocalService implements Service {
  ...
  public MdbcHeartbeatResponse apply(MdbcHeartbeatRequest request) {
      final Meta.ConnectionHandle ch =
              new Meta.ConnectionHandle(request.connectionId);
      meta.heartbeat(ch);
      return new MdbcHeartbeatResponse(request.connectionId);
  }
}
